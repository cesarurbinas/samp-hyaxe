...
{
	Logger_Debug("ClosePoliceDoor"); // debug juju
...
{
	Logger_Debug("CloseJailDoor"); // debug juju
...
{
	Logger_Debug("CloseMafiaDoor"); // debug juju
...
{
	Logger_Debug("ClosePoliceGarageDoor"); // debug juju
...
{
	Logger_Debug("CloseBarrier"); // debug juju
