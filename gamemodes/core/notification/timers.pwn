...
public TIMER_NotificationAlpha_0(playerid)
{
	if (g_iNotificationCount_0{playerid} == 255)
	{
		...
		SetPVarInt(playerid, "notification_timer_0", SetTimerEx("TIMER_NotificationMoveBar_0", 10, true, "i", playerid));
		return 1;
	}
...
public TIMER_NotificationAlpha_1(playerid)
{
	if (g_iNotificationCount_1{playerid} == 255)
	{
		...
		SetPVarInt(playerid, "notification_timer_1", SetTimerEx("TIMER_NotificationMoveBar_1", 10, true, "i", playerid));
		return 1;
	}
...
public TIMER_NotificationAlpha_2(playerid)
{
	if (g_iNotificationCount_2{playerid} == 255)
	{
		...
		SetPVarInt(playerid, "notification_timer_2", SetTimerEx("TIMER_NotificationMoveBar_2", 10, true, "i", playerid));
		return 1;
	}
