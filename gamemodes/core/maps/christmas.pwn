...
ChristmasMap()
{
    ...
    CreateDynamic3DTextLabel(""COL_YELLOW"Comprar fuegos artificiales"COL_WHITE"\n6 Productos disponibles", 0xF0F0F0FF, 1537.7760, -1658.0721, 13.5469, 20.0, .testlos = true, .worldid = 0, .interiorid = 0);
