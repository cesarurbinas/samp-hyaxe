GetItemNameByType(type)
{
	...
	switch(type)
	{
		...
		case 15: name = "Pala";
		case 16: name = "Palo de billar";
		case 17: name = "Gas";
		case 18: name = "Palo de golf";
		case 19: name = "Manopla";
		case 22: name = "9mm";
		case 23: name = "Tazer";
...
SetItemToBody(playerid, type)
{
	...
	switch(type)
	{
		...
		case 57: SetPlayerAttachedObject(playerid, 9, 19320, 6, 0.0699, 0.0289, 0.0000, -75.9000, -5.8000, -84.7999, 0.6219, 0.6579, 0.5109, 0xFFFFFFFF, 0xFFFFFFFF);
	}
	return 1;
}
