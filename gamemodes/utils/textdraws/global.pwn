...
CreateTextDraws()
{
	...
	TextDrawBoxColor(Textdraws[textdraw_GRAFFITI_PLUS][0], 0x1C1C1CEE);
	TextDrawSetShadow(Textdraws[textdraw_GRAFFITI_PLUS][0], 0);
	TextDrawSetOutline(Textdraws[textdraw_GRAFFITI_PLUS][0], 0);
	TextDrawBackgroundColor(Textdraws[textdraw_GRAFFITI_PLUS][0], 0x1C1C1CEE);
	...
	TextDrawBoxColor(Textdraws[textdraw_GRAFFITI][0], 0x1C1C1CEE);
	TextDrawSetShadow(Textdraws[textdraw_GRAFFITI][0], 0);
	TextDrawSetOutline(Textdraws[textdraw_GRAFFITI][0], 0);
	TextDrawBackgroundColor(Textdraws[textdraw_GRAFFITI][0], 0x1C1C1CEE);
